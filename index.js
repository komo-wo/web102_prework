...
document.getElementById('num-contributions').innerHTML = `${totalContributions.toLocaleString()}`;
...
const displayStr = `
  A total of ${GAMES_JSON.length} games have been funded through our platform. 
  ${numUnfunded > 0 
    ? `However, ${numUnfunded} ${numUnfunded === 1 ? "game remains" : "games remain"} unfunded. 
       We need your help to bring more creative visions to life!` 
    : "All games have been successfully funded — thank you for your support!"}
`;
